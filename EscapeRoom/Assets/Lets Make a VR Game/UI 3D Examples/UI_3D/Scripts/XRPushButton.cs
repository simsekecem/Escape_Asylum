...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRPushButton : UnityEngine.XR.Interaction.Toolkit.XRBaseInteractable
    {
        class PressInfo
        {
            internal UnityEngine.XR.Interaction.Toolkit.IXRHoverInteractor m_Interactor;
        ...
        Dictionary<UnityEngine.XR.Interaction.Toolkit.IXRHoverInteractor, PressInfo> m_HoveringInteractors = new Dictionary<UnityEngine.XR.Interaction.Toolkit.IXRHoverInteractor, PressInfo>();
        ...
        public override bool IsHoverableBy(UnityEngine.XR.Interaction.Toolkit.IXRHoverInteractor interactor)
        {
            if (interactor is UnityEngine.XR.Interaction.Toolkit.XRRayInteractor)
                return false;
